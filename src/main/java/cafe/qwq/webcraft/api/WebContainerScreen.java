...
public class WebContainerScreen<T extends Container> extends ContainerScreen
{
     ...
     * 添加一个网页View
     */
    public WebContainerScreen addView(View view) {
        viewList.add(view);
        try{
     ...
     * 设置当按下Esc键时是否关闭GUI
     */
    public WebContainerScreen setShouldCloseOnEsc(boolean shouldCloseOnEsc)
    {
     ...
     */
    public WebContainerScreen addPreRenderer(IRenderer renderer)
    {
     ...
     */
    public WebContainerScreen addPostRenderer(IRenderer renderer)
    {
